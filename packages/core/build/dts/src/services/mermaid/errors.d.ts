 ...
 */
export declare const makeRenderError: (message: string, diagram?: string) => MermaidError;
/**
 ...
 * @see {@link MermaidError} for error structure and usage
 */
export declare const makeParseError: (message: string, diagram?: string) => MermaidError;
/**
 ...
 * @see {@link MermaidError} for error structure and usage
 */
export declare const makeUnknownError: (message: string, diagram?: string) => MermaidError;
