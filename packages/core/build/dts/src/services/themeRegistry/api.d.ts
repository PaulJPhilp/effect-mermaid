...
import type { ThemeNotFoundError, InvalidThemeError, DuplicateThemeError } from "./errors.js";
/**
...
export interface ThemeRegistryApi {
     ...
     */
    readonly registerTheme: (name: string, theme: DiagramTheme) => Effect.Effect<void, DuplicateThemeError | InvalidThemeError>;
    /**
     ...
     */
    readonly getTheme: (name: string) => Effect.Effect<ThemeConfig, ThemeNotFoundError>;
    /**
