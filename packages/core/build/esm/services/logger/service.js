 ...
 */
export class Logger extends /*#__PURE__*/Effect.Service()("effect-mermaid/Logger", {
  sync: () => ({
 ...
 */
export class SilentLogger extends /*#__PURE__*/Effect.Service()("effect-mermaid/SilentLogger", {
  sync: () => ({
    info: () => Effect.void,
    warn: () => Effect.void,
    error: () => Effect.void,
