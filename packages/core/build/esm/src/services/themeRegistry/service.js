...
export class ThemeRegistry extends /*#__PURE__*/Effect.Service()("effect-mermaid/ThemeRegistry", {
  scoped: /*#__PURE__*/Effect.gen(function* ($) {
    const themes = new Map(Object.entries(BUILT_IN_THEMES).map(([name, theme]) => [name, {
      ...theme,
