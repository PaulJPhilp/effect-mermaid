 ...
 */
export const ThemeColorValueSchema = Schema.Union(Schema.String, Schema.Number, Schema.Struct({
...
export const MermaidConfig = Schema.Struct({
    ...
    themeVariables: Schema.optional(Schema.Record({ key: Schema.String, value: Schema.Unknown })),
    securityLevel: Schema.optional(Schema.Union(Schema.Literal("strict"), Schema.Literal("loose"), Schema.Literal("antiscript"))),
    flowchart: Schema.optional(Schema.Record({ key: Schema.String, value: Schema.Unknown })),
    sequence: Schema.optional(Schema.Record({ key: Schema.String, value: Schema.Unknown })),
    class: Schema.optional(Schema.Record({ key: Schema.String, value: Schema.Unknown })),
    state: Schema.optional(Schema.Record({ key: Schema.String, value: Schema.Unknown })),
});
