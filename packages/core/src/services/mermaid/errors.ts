 ...
 */
export const makeRenderError = (message: string, diagram?: string): MermaidError =>
  new MermaidError({
    reason: "Render",
    message,
 ...
 * @see {@link MermaidError} for error structure and usage
 */
export const makeParseError = (message: string, diagram?: string): MermaidError =>
  new MermaidError({
    reason: "Parse",
    message,
    ...(diagram !== undefined ? { diagram } : {})
 ...
 * @see {@link MermaidError} for error structure and usage
 */
export const makeUnknownError = (message: string, diagram?: string): MermaidError =>
  new MermaidError({
    reason: "Unknown",
    message,
    ...(diagram !== undefined ? { diagram } : {})
