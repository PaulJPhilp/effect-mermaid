...
// Create context for Effect layer
// The layer provides both BrowserMermaid and ThemeRegistry services
// Both are merged together so they're available in the Effect context
export type MermaidLayer = Layer.Layer<
	BrowserMermaid | ThemeRegistryApi,
	MermaidError,
	never
>;

interface MermaidLayerContextValue {
	layer: MermaidLayer | null;
	isInitialized: boolean;
}

const EffectLayerContext = createContext<MermaidLayerContextValue | null>(null);
 ...
 */
export const MermaidProvider: React.FC<MermaidProviderProps> = ({
	children,
	config,
}) => {
